 ...
 */
export const createMockAgent = (name: string = 'test-agent', overrides: Partial<SDK.Agent> = {}): SDK.Agent =>
    ({
        sendMessage: jest.fn(() =>
            Promise.resolve({
                kind: 'task' as const,
 ...
 */
export const createValidAgentConfig = (overrides: Partial<AgentConfiguration> = {}): AgentConfiguration => ({
    protocolVersion: '0.3.0',
    schemaVersion: '0.1.0',
    uri: 'test-agent-uri',
    name: 'test-agent',
...
export const createValidStoredAgent = (overrides: Partial<armada.StoredAgent> = {}): armada.StoredAgent => ({
    uri: 'test-agent-id',
    name: 'test-agent',
...
export const createMockResponse = (): Partial<Response> & {
    ...
    const res: any = {
        ...
        writeHead: jest.fn(function (code: number, headers: Record<string, unknown>) {
            res._statusCode = code;
 ...
 */
export const createMockRequest = (overrides: Partial<ExpressRequest> = {}): Partial<ExpressRequest> => ({
    body: {},
    params: {},
    path: '/test',
    headers: {},
 ...
 * Creates a mock Express request
 */
export const createMockHonoRequest = (overrides: Partial<Request> = {}): Partial<Request> => ({
    body: null,
    headers: new Headers(),
    ...overrides,
});
