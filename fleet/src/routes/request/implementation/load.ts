...
const requiredAgentsNotLoaded = (config: AgentConfiguration, context: RequestContext) => {
...
export const loadAgent: loadFunction = async (config: AgentConfiguration, context?: RequestContext) => {
    if (!context) {
