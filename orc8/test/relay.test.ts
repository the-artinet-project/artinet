import { Discover } from "../src/modules/relay/index.js";
...
import { DiscoverableRelay } from "../src/modules/relay/discover.js";
...
describe("Relay", () => {
  ...
  it("should pass empty array when no servers found", async () => {
    ...
    expect(configs?.length).toBeDefined();
  });
