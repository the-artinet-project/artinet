 ...
 * ```
 */
export class Tool implements Callable.Tool, core.Service<ServiceRequest, Runtime.ToolResponse> {
    /**
     ...
     */
    async execute({ request, options }: ServiceRequest): Promise<Runtime.ToolResponse> {
     ...
     */
    static from(client: MCPClient, transport: MCPTransport, uri: string = uuidv4()): Tool {
