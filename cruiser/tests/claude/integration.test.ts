...
describe('Claude Integration', () => {
    ...
    it(
        ...
        async () => {
            ...
            const task = await a2agent.sendMessage('What is 5 + 5? Reply with just the number.').catch((error) => {
                console.error(error);
                return null;
            });
    ...
    it(
        ...
        async () => {
            ...
            const task = await a2agent.sendMessage('What is your name?').catch((error) => {
                console.error(error);
                return null;
            });
